I created an application that will register orders for a burger restaurant, and I used Node and Express. And for the order id generation, I used the UUID V4 library
